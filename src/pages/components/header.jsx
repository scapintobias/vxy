...
export const HomeHead = () => (
	<section className="absolute z-max bottom-0 ph5 pb5 w-100 flex justify-between">
		...
		S8.3,6.8,10,6.8c1.7,0,3.2,1.4,3.2,3.2C13.2,11.7,11.7,13.2,10,13.2z"
			...
			<NavLink to="/portfolio" className="link white hover-gold pr3">
				ABOUT
			</NavLink>
			<NavLink to="/portfolio" className="link white hover-gold ">
				CONTACTS
			</NavLink>
		</div>
	</section>
...
export const AllHead = () => (
	<>
		<section className="absolute dib z-max ph5 pt4 w-100 flex justify-between">
			<NavLink
				to="/"
		...
		S8.3,6.8,10,6.8c1.7,0,3.2,1.4,3.2,3.2C13.2,11.7,11.7,13.2,10,13.2z"
				...
				<NavLink to="/portfolio" className="link silver hover-gold pr3">
					ABOUT
				</NavLink>
				<NavLink to="/portfolio" className="link silver hover-gold ">
					CONTACTS
				</NavLink>
			</div>
		</section>
		<div className="absolute z-2 ph5 h4 flex w-100">
