...
export const Portfolio = () => (
	<main>
		...
		<Main>
			<Spacer h="h4" />
			<Flex width="w-70 w-60-ns w-100-m" class="center">
			...
			<Land
				to="/"
				container="w-70 w-60-ns w-100-m center"
				article="dim"
			...
			<Flex width="w-100" class="flex-column-m justify-between w-60-ns center-ns">
				...
				<Flex width="w-50 w-100-m" class="flex-column ml3 ml0-m">
					...
					<StaTall
						container="w-70-m center-m mb6-m"
			...
			<Land
				to="/progetti/yape"
				container="w-70 w-60-ns center-ns center w-100-m"
				article="dim"
			...
			/>
			<Spacer h="h5 h3-m" />
			<Flex width="w-100" class="flex-column-m justify-around  w-60-ns center-ns">
				<Flex width="w-50 w-100-m" class="flex-column mr3 mr0-m">
					<Land
						to="/progetti/yape"
						container="w-100-m mb4"
